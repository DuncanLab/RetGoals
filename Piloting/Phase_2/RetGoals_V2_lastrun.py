...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/matthewdougherty/Desktop/Projects/RetGoals_Git/Piloting/Phase_2/RetGoals_V2_lastrun.py',
...
EAinstructions_image = ''
Encinstructions_image = ''
IAinstructions_image = ''
Retinstructions_image = ''
...
welcomeText = visual.TextStim(win=win, name='welcomeText',
    text='Welcome, and thank you for agreeing to participate in our study! \n\nDuring this study, you will complete a series of tasks. There will be 4 tasks per block, and a total of 10 blocks. Between each block, you will have a 30 second break. If at any point you need to stop the experiment, please wait until the end of the current task, then ask the experimenter for assistance. \n\nPress the spacebar to continue.',
    font='Open Sans',
...
welcomeText2 = visual.TextStim(win=win, name='welcomeText2',
    text='You will first go through a set of practice trials to get the hang of each task. Before we begin, place the first three fingers of your dominant hand over the “t”, “y”, and “u” keys on the keyboard. Place your thumb on the spacebar. Press the spacebar to begin.',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
EAPracticeText2 = visual.TextStim(win=win, name='EAPracticeText2',
    text='For this task, you will see a set of shapes on screen. Some of the shapes will be large, and some of the shapes will be small. At the top of the screen, you will see an equation that reads “big _ small”. Your job is to count the number of big and small shapes on screen. You will be prompted to fill in the symbol that makes the equation correct. \n\nEach of the symbols on the bottom of the screen corresponds to the four keys: > is t, = is y, and < is u. The ? is the spacebar. If there are more big shapes than small shapes, the correct answer is > (press “t”). If there are fewer big shapes than small shapes, the correct answer is < (press “u”). If they are equal, the correct answer is = (press “y”). If you cannot tell or are not confident, feel free to answer with ? (press the spacebar). \n\nPress space to continue. ',
    font='Open Sans',
...
EAPractice2Text = visual.TextStim(win=win, name='EAPractice2Text',
    text="You will now practice the task without a time constraint. The shapes will appear on screen for 1.5 seconds, after which you will be able to make a response. Press 'space' to begin.",
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
EAPracticeEndText = visual.TextStim(win=win, name='EAPracticeEndText',
    text="Well Done! We'll now move on to the next set of task instructions and practice. Press space to continue.",
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
IAPracticeInstructions1Text2 = visual.TextStim(win=win, name='IAPracticeInstructions1Text2',
    text='For this task, you will see a set of math problems on screen, one on the left and one on the right. The blank space in the middle is the symbol that makes the equation correct. You will be prompted to fill in the symbol that makes the equation correct. \n\nEach of the symbols on the bottom of the screen corresponds to the four keys: > is t, = is y, and < is u. The ? is space. If the answer to the equation on the left is greater than the answer to the equation on the right, the correct answer is > (press “t”). If the answer to the equation on the left is less than the answer to the equation on the right, the correct answer is < (press “u”). If they are equal, the correct answer is = (press “y”). If you cannot tell or are not confident, feel free to answer with ? (press the spacebar). \n\nPress space to continue. ',
    font='Open Sans',
    pos=(0, 0), height=0.035, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
IAPracticeInstructions2Text = visual.TextStim(win=win, name='IAPracticeInstructions2Text',
    text='You will now practice the task without a time constraint. The problems will appear on screen for 1.5 seconds, after which you will be able to make a response. Press space to begin.',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
EncPracticeInstructions2Text = visual.TextStim(win=win, name='EncPracticeInstructions2Text',
    text='You will now practice the task without a time constraint. The images will appear on screen for 1.5 seconds, after which you will be able to make a response. Press space to begin.',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
RetPracticeInstructionsText2 = visual.TextStim(win=win, name='RetPracticeInstructionsText2',
    text='For this task, your memory for the images shown during the learning task will be tested. You will see one image on screen, and you will be asked which of the images at the bottom of the screen was previously shown with it.\n\nEach of the symbols on the bottom of the screen corresponds to the four keys. If you think the image was shown with the berries,  press “t”. If you think the image was shown with the truck,  press “y”. If you think the image was shown with the house,  press “u”. If you cannot tell or are not confident, feel free to answer with ? (press the spacebar).\n\nPress space to continue. ',
    font='Open Sans',
    pos=(0, 0), height=0.035, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
RetPracticeInstructions2Text = visual.TextStim(win=win, name='RetPracticeInstructions2Text',
    text='You will now practice the task without a time constraint. An image will appear on screen for 1.5 seconds, after which you will be able to make a response. Press space to begin.',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
EATaskInstructionsText2 = visual.TextStim(win=win, name='EATaskInstructionsText2',
    text="Count the number of big and small shapes on screen, and answer whether there are more big shapes on screen (>), equal amounts of big and small shapes (=), are fewer big than small shapes (<). Make sure your fingers are placed on the 't', 'y', and 'u' keys. Press 'space' to begin.",
    font='Open Sans',
    pos=(0, -0.35), height=0.035, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-2.0);
EAStart = keyboard.Keyboard()
EAInstructionsImage = visual.ImageStim(
    win=win,
    name='EAInstructionsImage', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(0.4, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-4.0)

# --- Initialize components for Routine "KeyCheck" ---
KeyCheckText = visual.TextStim(win=win, name='KeyCheckText',
    text='',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=0.0);
KeyCheckResp = keyboard.Keyboard()
...
EncTaskInstructionsText2 = visual.TextStim(win=win, name='EncTaskInstructionsText2',
    text="Compare the size of the images and answer whether the image on the right is bigger (>), the images are equal (=), or the image on the left is smaller (<). Remember, your memory for these images will be tested later! Make sure your fingers are placed on the 't', 'y', and 'u' keys. Press 'space' to begin",
    font='Open Sans',
    pos=(0, -0.35), height=0.035, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-1.0);
EncInstructionsImage = visual.ImageStim(
    win=win,
    name='EncInstructionsImage', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(0.5, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-2.0)
EncStart = keyboard.Keyboard()
...
IATaskInstructionsText2 = visual.TextStim(win=win, name='IATaskInstructionsText2',
    text="Calculate the equations in your head and answer whether the equation on the left is greater (>), they are equal (=), or the equation on the left is less (<). Make sure your fingers are placed on the 't', 'y', and 'u' keys. Press 'space' to begin.",
    font='Open Sans',
    pos=(0, 0), height=0.035, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-1.0);
IAStart = keyboard.Keyboard()
IAInstructionsImage = visual.ImageStim(
    win=win,
    name='IAInstructionsImage', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(0.45, 0.35),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-3.0)
...
RetTaskInstructionsText2 = visual.TextStim(win=win, name='RetTaskInstructionsText2',
    text="Look at the image on screen and answer whether it was shown with the berries, the truck, or the house. Make sure your fingers are placed on the 't', 'y', and 'u' keys. Press 'space' to begin.",
    font='Open Sans',
    pos=(0, 0), height=0.035, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-1.0);
RetInstructionsImage = visual.ImageStim(
    win=win,
    name='RetInstructionsImage', 
    image='sin', mask=None, anchor='center',
...
ret_shuf1 = shuffled_order[5:30]
shuffle(ret_shuf1)
ret_shuf2 = shuffled_order[30:55]
shuffle(ret_shuf2)
ret_shuf3 = shuffled_order[55:80]
shuffle(ret_shuf3)
ret_shuf4 = shuffled_order[80:105]
shuffle(ret_shuf4)
ret_shuf5 = shuffled_order[105:130]
shuffle(ret_shuf5)
ret_shuf6 = shuffled_order[130:155]
shuffle(ret_shuf6)
ret_shuf7 = shuffled_order[155:180]
shuffle(ret_shuf7)
ret_shuf8 = shuffled_order[180:205]
shuffle(ret_shuf8)
ret_shuf9 = shuffled_order[205:230]
shuffle(ret_shuf9)
ret_shuf10 = shuffled_order[230:255]
shuffle(ret_shuf10)
...
while continueRoutine:
    ...
    if welcomeKey2.status == STARTED and not waitOnFlip:
        theseKeys = welcomeKey2.getKeys(keyList=['space'], waitRelease=False)
...
while continueRoutine:
    ...
    if EAPractice2Key.status == STARTED and not waitOnFlip:
        theseKeys = EAPractice2Key.getKeys(keyList=['space'], waitRelease=False)
...
EAinstructions_image = EA_image_fp
...
while continueRoutine:
    ...
    if EAPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = EAPractice1Resp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if EAPostPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = EAPostPractice1Resp.getKeys(keyList=['space'], waitRelease=False)
...
for thisEAPractice2Trial in EAPractice2Trials:
    ...
    thisExp.addData('stim_spec', ea_stim_spec[shuffled_order[ea_stim_counter]])
    thisExp.addData('num_big', ea_stim_big[shuffled_order[ea_stim_counter]])
    thisExp.addData('task', ea_stim_task[shuffled_order[ea_stim_counter]])
    ea_stim_counter += 1
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        # *EATrialResp* updates
        waitOnFlip = False
        if EATrialResp.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
        ...
        if EATrialResp.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > EATrialResp.tStartRefresh + 3.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if EATrialResp.status == STARTED and not waitOnFlip:
            theseKeys = EATrialResp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
            _EATrialResp_allKeys.extend(theseKeys)
            if len(_EATrialResp_allKeys):
                EATrialResp.keys = _EATrialResp_allKeys[0].name  # just the first key pressed
                EATrialResp.rt = _EATrialResp_allKeys[0].rt
                # was this correct?
...
while continueRoutine:
    ...
    if EAPracticeEndKey.status == STARTED and not waitOnFlip:
        theseKeys = EAPracticeEndKey.getKeys(keyList=['space'], waitRelease=False)
...
while continueRoutine:
    ...
    if IAPracticeInstructions2Resp.status == STARTED and not waitOnFlip:
        theseKeys = IAPracticeInstructions2Resp.getKeys(keyList=['space'], waitRelease=False)
...
IAinstructions_image = IA_image_fp
...
while continueRoutine:
    ...
    if IAPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = IAPractice1Resp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if IAPostPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = IAPostPractice1Resp.getKeys(keyList=['space'], waitRelease=False)
...
for thisIAPractice2Trial in IAPractice2Trials:
    ...
    thisExp.addData('stim_spec', ia_stim_spec[shuffled_order[ia_stim_counter]])
    thisExp.addData('has_neg', ia_stim_hasneg[shuffled_order[ia_stim_counter]])
    thisExp.addData('task', ia_stim_task[shuffled_order[ia_stim_counter]])
    ia_stim_counter += 1
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        if IATrialResp.status == STARTED and not waitOnFlip:
            theseKeys = IATrialResp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if IAPracticeEndResp.status == STARTED and not waitOnFlip:
        theseKeys = IAPracticeEndResp.getKeys(keyList=['space'], waitRelease=False)
...
while continueRoutine:
    ...
    if EncPracticeInstructions2Resp.status == STARTED and not waitOnFlip:
        theseKeys = EncPracticeInstructions2Resp.getKeys(keyList=['space'], waitRelease=False)
...
Encinstructions_image = Enc_image_fp
...
while continueRoutine:
    ...
    if EncPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = EncPractice1Resp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if EncPractice1FeedbackResp.status == STARTED and not waitOnFlip:
        theseKeys = EncPractice1FeedbackResp.getKeys(keyList=['space'], waitRelease=False)
...
for thisEncPractice2Trial in EncPractice2Trials:
    ...
    thisExp.addData('stim_name', enc_stim[shuffled_order[enc_stim_counter]])
    thisExp.addData('stim_spec', enc_stim_spec[shuffled_order[enc_stim_counter]])
    thisExp.addData('task', enc_stim_task[shuffled_order[enc_stim_counter]])
    enc_stim_counter += 1
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        if EncTrialResp.status == STARTED and not waitOnFlip:
            theseKeys = EncTrialResp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if EncPracticeEndResp.status == STARTED and not waitOnFlip:
        theseKeys = EncPracticeEndResp.getKeys(keyList=['space'], waitRelease=False)
...
while continueRoutine:
    ...
    if RetPracticeInstructions2Resp.status == STARTED and not waitOnFlip:
        theseKeys = RetPracticeInstructions2Resp.getKeys(keyList=['space'], waitRelease=False)
...
Retinstructions_image = Ret_image_fp
...
while continueRoutine:
    ...
    if RetPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = RetPractice1Resp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if RetPostPractice1Resp.status == STARTED and not waitOnFlip:
        theseKeys = RetPostPractice1Resp.getKeys(keyList=['space'], waitRelease=False)
...
for thisRetPractice2Trial in RetPractice2Trials:
    ...
    thisExp.addData('stim_spec', ret_stim_spec[ret_shuffled_order[ret_stim_counter]])
    thisExp.addData('enc_stimname', ret_enc_stimname[ret_shuffled_order[ret_stim_counter]])
    thisExp.addData('task', ret_stim_task[shuffled_order[ret_stim_counter]])
    ret_stim_counter += 1
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        if RetTrialResp.status == STARTED and not waitOnFlip:
            theseKeys = RetTrialResp.getKeys(keyList=['t','y','u','space'], waitRelease=False)
...
while continueRoutine:
    ...
    if RetPracticeEndResp.status == STARTED and not waitOnFlip:
        theseKeys = RetPracticeEndResp.getKeys(keyList=['space'], waitRelease=False)
...
for thisBlock in Blocks:
    ...
    EAStart.rt = []
    _EAStart_allKeys = []
    EAInstructionsImage.setImage(EAinstructions_image)
    # keep track of which components have finished
    EATaskInstructionsComponents = [EATaskInstructionsText1, EATaskInstructionsText2, EAStart, EAInstructionsImage]
    ...
    while continueRoutine:
        ...
        # *EAStart* updates
        waitOnFlip = False
        if EAStart.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            EAStart.frameNStart = frameN  # exact frame index
            EAStart.tStart = t  # local t and not account for scr refresh
            EAStart.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(EAStart, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'EAStart.started')
            EAStart.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(EAStart.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(EAStart.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if EAStart.status == STARTED and not waitOnFlip:
            theseKeys = EAStart.getKeys(keyList=['space'], waitRelease=False)
            _EAStart_allKeys.extend(theseKeys)
            if len(_EAStart_allKeys):
                EAStart.keys = _EAStart_allKeys[-1].name  # just the last key pressed
                EAStart.rt = _EAStart_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
        
        # *EAInstructionsImage* updates
        if EAInstructionsImage.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            EAInstructionsImage.frameNStart = frameN  # exact frame index
            EAInstructionsImage.tStart = t  # local t and not account for scr refresh
            EAInstructionsImage.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(EAInstructionsImage, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'EAInstructionsImage.started')
            EAInstructionsImage.setAutoDraw(True)
    ...
    for thisComponent in EATaskInstructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
    if EAStart.keys in ['', [], None]:  # No response was made
        EAStart.keys = None
    Blocks.addData('EAStart.keys',EAStart.keys)
    if EAStart.keys != None:  # we had a response
        Blocks.addData('EAStart.rt', EAStart.rt)
    # the Routine "EATaskInstructions" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # --- Prepare to start Routine "KeyCheck" ---
    continueRoutine = True
    routineForceEnded = False
    # update component parameters for each repeat
    KeyCheckText.setText("Please make sure your first three fingers are on the 't', 'y', and 'u' keys, and that your thumb is on the spacebar. Press space to continue.")
    KeyCheckResp.keys = []
    KeyCheckResp.rt = []
    _KeyCheckResp_allKeys = []
    # keep track of which components have finished
    KeyCheckComponents = [KeyCheckText, KeyCheckResp]
    for thisComponent in KeyCheckComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    while continueRoutine:
        ...
        # *KeyCheckText* updates
        if KeyCheckText.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            KeyCheckText.frameNStart = frameN  # exact frame index
            KeyCheckText.tStart = t  # local t and not account for scr refresh
            KeyCheckText.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(KeyCheckText, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'KeyCheckText.started')
            KeyCheckText.setAutoDraw(True)
        
        # *KeyCheckResp* updates
        waitOnFlip = False
        if KeyCheckResp.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            KeyCheckResp.frameNStart = frameN  # exact frame index
            KeyCheckResp.tStart = t  # local t and not account for scr refresh
            KeyCheckResp.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(KeyCheckResp, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'KeyCheckResp.started')
            KeyCheckResp.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(KeyCheckResp.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(KeyCheckResp.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if KeyCheckResp.status == STARTED and not waitOnFlip:
            theseKeys = KeyCheckResp.getKeys(keyList=['space'], waitRelease=False)
            _KeyCheckResp_allKeys.extend(theseKeys)
            if len(_KeyCheckResp_allKeys):
                KeyCheckResp.keys = _KeyCheckResp_allKeys[-1].name  # just the last key pressed
                KeyCheckResp.rt = _KeyCheckResp_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
    ...
    # --- Ending Routine "KeyCheck" ---
    for thisComponent in KeyCheckComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
    if KeyCheckResp.keys in ['', [], None]:  # No response was made
        KeyCheckResp.keys = None
    Blocks.addData('KeyCheckResp.keys',KeyCheckResp.keys)
    if KeyCheckResp.keys != None:  # we had a response
        Blocks.addData('KeyCheckResp.rt', KeyCheckResp.rt)
    # the Routine "KeyCheck" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # set up handler to look after randomisation of conditions etc
    EATrials = data.TrialHandler(nReps=25.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='EATrials')
    thisExp.addLoop(EATrials)  # add the loop to the experiment
    thisEATrial = EATrials.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisEATrial.rgb)
    if thisEATrial != None:
        for paramName in thisEATrial:
            exec('{} = thisEATrial[paramName]'.format(paramName))
    
    for thisEATrial in EATrials:
        currentLoop = EATrials
        # abbreviate parameter names if possible (e.g. rgb = thisEATrial.rgb)
        if thisEATrial != None:
            for paramName in thisEATrial:
                exec('{} = thisEATrial[paramName]'.format(paramName))
        ...
        if EATrialResp.keys in ['', [], None]:  # No response was made
            ...
            if str(EA_corrkey).lower() == 'none':
               ...
               EATrialResp.corr = 0;  # failed to respond (incorrectly)
        # store data for EATrials (TrialHandler)
        EATrials.addData('EATrialResp.keys',EATrialResp.keys)
        EATrials.addData('EATrialResp.corr', EATrialResp.corr)
        if EATrialResp.keys != None:  # we had a response
            EATrials.addData('EATrialResp.rt', EATrialResp.rt)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    # completed 25.0 repeats of 'EATrials'
    ...
    EncInstructionsImage.setImage(Encinstructions_image)
    EncStart.keys = []
    EncStart.rt = []
    _EncStart_allKeys = []
    # keep track of which components have finished
    EncTaskInstructionsComponents = [EncTaskInstructionsText1, EncTaskInstructionsText2, EncInstructionsImage, EncStart]
    ...
    while continueRoutine:
        ...
        # *EncInstructionsImage* updates
        if EncInstructionsImage.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            EncInstructionsImage.frameNStart = frameN  # exact frame index
            EncInstructionsImage.tStart = t  # local t and not account for scr refresh
            EncInstructionsImage.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(EncInstructionsImage, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'EncInstructionsImage.started')
            EncInstructionsImage.setAutoDraw(True)
        
        # *EncStart* updates
        waitOnFlip = False
        if EncStart.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            EncStart.frameNStart = frameN  # exact frame index
            EncStart.tStart = t  # local t and not account for scr refresh
            EncStart.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(EncStart, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'EncStart.started')
            EncStart.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(EncStart.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(EncStart.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if EncStart.status == STARTED and not waitOnFlip:
            theseKeys = EncStart.getKeys(keyList=['space'], waitRelease=False)
            _EncStart_allKeys.extend(theseKeys)
            if len(_EncStart_allKeys):
                EncStart.keys = _EncStart_allKeys[-1].name  # just the last key pressed
                EncStart.rt = _EncStart_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
    ...
    for thisComponent in EncTaskInstructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
    if EncStart.keys in ['', [], None]:  # No response was made
        EncStart.keys = None
    Blocks.addData('EncStart.keys',EncStart.keys)
    if EncStart.keys != None:  # we had a response
        Blocks.addData('EncStart.rt', EncStart.rt)
    # the Routine "EncTaskInstructions" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    # set up handler to look after randomisation of conditions etc
    EncTrials = data.TrialHandler(nReps=25.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='EncTrials')
    thisExp.addLoop(EncTrials)  # add the loop to the experiment
    thisEncTrial = EncTrials.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisEncTrial.rgb)
    if thisEncTrial != None:
        for paramName in thisEncTrial:
            exec('{} = thisEncTrial[paramName]'.format(paramName))
    
    for thisEncTrial in EncTrials:
        currentLoop = EncTrials
        # abbreviate parameter names if possible (e.g. rgb = thisEncTrial.rgb)
        if thisEncTrial != None:
            for paramName in thisEncTrial:
                exec('{} = thisEncTrial[paramName]'.format(paramName))
        ...
        if EncTrialResp.keys in ['', [], None]:  # No response was made
            ...
            if str(Enc_corrkey).lower() == 'none':
               ...
               EncTrialResp.corr = 0;  # failed to respond (incorrectly)
        # store data for EncTrials (TrialHandler)
        EncTrials.addData('EncTrialResp.keys',EncTrialResp.keys)
        EncTrials.addData('EncTrialResp.corr', EncTrialResp.corr)
        if EncTrialResp.keys != None:  # we had a response
            EncTrials.addData('EncTrialResp.rt', EncTrialResp.rt)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    # completed 25.0 repeats of 'EncTrials'
    ...
    IAStart.rt = []
    _IAStart_allKeys = []
    IAInstructionsImage.setImage(IAinstructions_image)
    # keep track of which components have finished
    IATaskInstructionsComponents = [IATaskInstructionsText1, IATaskInstructionsText2, IAStart, IAInstructionsImage]
    ...
    while continueRoutine:
        ...
        # *IAStart* updates
        waitOnFlip = False
        if IAStart.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            IAStart.frameNStart = frameN  # exact frame index
            IAStart.tStart = t  # local t and not account for scr refresh
            IAStart.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(IAStart, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'IAStart.started')
            IAStart.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(IAStart.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(IAStart.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if IAStart.status == STARTED and not waitOnFlip:
            theseKeys = IAStart.getKeys(keyList=['space'], waitRelease=False)
            _IAStart_allKeys.extend(theseKeys)
            if len(_IAStart_allKeys):
                IAStart.keys = _IAStart_allKeys[-1].name  # just the last key pressed
                IAStart.rt = _IAStart_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
        
        # *IAInstructionsImage* updates
        if IAInstructionsImage.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            IAInstructionsImage.frameNStart = frameN  # exact frame index
            IAInstructionsImage.tStart = t  # local t and not account for scr refresh
            IAInstructionsImage.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(IAInstructionsImage, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'IAInstructionsImage.started')
            IAInstructionsImage.setAutoDraw(True)
    ...
    for thisComponent in IATaskInstructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
    if IAStart.keys in ['', [], None]:  # No response was made
        IAStart.keys = None
    Blocks.addData('IAStart.keys',IAStart.keys)
    if IAStart.keys != None:  # we had a response
        Blocks.addData('IAStart.rt', IAStart.rt)
    # the Routine "IATaskInstructions" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    # set up handler to look after randomisation of conditions etc
    IATrials = data.TrialHandler(nReps=25.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='IATrials')
    thisExp.addLoop(IATrials)  # add the loop to the experiment
    thisIATrial = IATrials.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisIATrial.rgb)
    if thisIATrial != None:
        for paramName in thisIATrial:
            exec('{} = thisIATrial[paramName]'.format(paramName))
    
    for thisIATrial in IATrials:
        currentLoop = IATrials
        # abbreviate parameter names if possible (e.g. rgb = thisIATrial.rgb)
        if thisIATrial != None:
            for paramName in thisIATrial:
                exec('{} = thisIATrial[paramName]'.format(paramName))
        ...
        if IATrialResp.keys in ['', [], None]:  # No response was made
            ...
            if str(IA_corrkey).lower() == 'none':
               ...
               IATrialResp.corr = 0;  # failed to respond (incorrectly)
        # store data for IATrials (TrialHandler)
        IATrials.addData('IATrialResp.keys',IATrialResp.keys)
        IATrials.addData('IATrialResp.corr', IATrialResp.corr)
        if IATrialResp.keys != None:  # we had a response
            IATrials.addData('IATrialResp.rt', IATrialResp.rt)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    # completed 25.0 repeats of 'IATrials'
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    RetInstructionsImage.setImage(Retinstructions_image)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    RetTaskInstructionsComponents = [RetTaskInstructionsText1, RetTaskInstructionsText2, RetInstructionsImage, key_resp]
    ...
    while continueRoutine:
        ...
        # *RetInstructionsImage* updates
        if RetInstructionsImage.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            RetInstructionsImage.frameNStart = frameN  # exact frame index
            RetInstructionsImage.tStart = t  # local t and not account for scr refresh
            RetInstructionsImage.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(RetInstructionsImage, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'RetInstructionsImage.started')
            RetInstructionsImage.setAutoDraw(True)
    ...
    # the Routine "RetTaskInstructions" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    # set up handler to look after randomisation of conditions etc
    RetTrials = data.TrialHandler(nReps=25.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='RetTrials')
    thisExp.addLoop(RetTrials)  # add the loop to the experiment
    thisRetTrial = RetTrials.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisRetTrial.rgb)
    if thisRetTrial != None:
        for paramName in thisRetTrial:
            exec('{} = thisRetTrial[paramName]'.format(paramName))
    
    for thisRetTrial in RetTrials:
        currentLoop = RetTrials
        # abbreviate parameter names if possible (e.g. rgb = thisRetTrial.rgb)
        if thisRetTrial != None:
            for paramName in thisRetTrial:
                exec('{} = thisRetTrial[paramName]'.format(paramName))
        ...
        if RetTrialResp.keys in ['', [], None]:  # No response was made
            ...
            if str(Ret_corrkey).lower() == 'none':
               ...
               RetTrialResp.corr = 0;  # failed to respond (incorrectly)
        # store data for RetTrials (TrialHandler)
        RetTrials.addData('RetTrialResp.keys',RetTrialResp.keys)
        RetTrials.addData('RetTrialResp.corr', RetTrialResp.corr)
        if RetTrialResp.keys != None:  # we had a response
            RetTrials.addData('RetTrialResp.rt', RetTrialResp.rt)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    # completed 25.0 repeats of 'RetTrials'
    ...
    if block_counter < 10:
        block1endtext = 'You have finished block {} of 10! You will now have a brief 30 second break before the beginning of the next one. Feel free to stretch out, but please do not use any technology or leave the testing room.'.format(block_counter)
    elif block_counter == 10:
        block1endtext = 'You have finished the experiment! Please let the experimenter know you are done. Thanks for participating!'
